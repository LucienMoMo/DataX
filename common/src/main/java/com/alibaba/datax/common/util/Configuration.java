...
//        Configuration conf = from(new File("/Users/yanghaijun/Documents/code/github/azkaban-dev/BI_project/src/topic_board/daily/用户活跃/mysql.topic_board_active_user_daily.json"));
//        System.out.println(conf);
//        conf.set("job.content[0].writer.parameter.password", "Momo0225");
//        System.out.println(conf.getString("job.content[0].writer.parameter.password"));
//        System.out.println(conf.getString("name"));
//        System.out.println(DDConfig.getSingleton().getDdConfigMap().get("mysql.data_core.writer.password"));

    }

//    private static Configuration genUserInfoSetting(Configuration configuration) {
//        if (configuration == null) return configuration;
//        //LOG.info("genUserInfoSetting - " + configuration.toString());
//        if ("true".equals(configuration.getString(CommonConstant.DD_CONF))) {
//            LOG.info("从ddconfig中获取用户名和密码");
//            // writer username
//            if (configuration.getString(CommonConstant.DATAX_JOB_CONTENT_WRITER_PARAMETER_USER) != null)
//                configuration.set(CommonConstant.DATAX_JOB_CONTENT_WRITER_PARAMETER_USER, DDConfig.getSingleton().getDdConfigMap().get(configuration.getString(CommonConstant.DATAX_JOB_CONTENT_WRITER_PARAMETER_USER)));
//            // writer password
//            if (configuration.getString(CommonConstant.DATAX_JOB_CONTENT_WRITER_PARAMETER_PASS) != null)
//                configuration.set(CommonConstant.DATAX_JOB_CONTENT_WRITER_PARAMETER_PASS, DDConfig.getSingleton().getDdConfigMap().get(configuration.getString(CommonConstant.DATAX_JOB_CONTENT_WRITER_PARAMETER_PASS)));
//            // reader username
//            if (configuration.getString(CommonConstant.DATAX_JOB_CONTENT_READER_PARAMETER_USER) != null)
//                configuration.set(CommonConstant.DATAX_JOB_CONTENT_READER_PARAMETER_USER, DDConfig.getSingleton().getDdConfigMap().get(configuration.getString(CommonConstant.DATAX_JOB_CONTENT_READER_PARAMETER_USER)));
//            // reader password
//            if (configuration.getString(CommonConstant.DATAX_JOB_CONTENT_READER_PARAMETER_PASS) != null)
//                configuration.set(CommonConstant.DATAX_JOB_CONTENT_READER_PARAMETER_PASS, DDConfig.getSingleton().getDdConfigMap().get(configuration.getString(CommonConstant.DATAX_JOB_CONTENT_READER_PARAMETER_PASS)));
//        }
